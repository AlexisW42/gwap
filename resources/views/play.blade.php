...
@endisset
	...
	@elseif($game->endTime == null)
        <div class="text-center">
            <div role="status">
                <svg aria-hidden="true" class="inline w-32 h-32 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
